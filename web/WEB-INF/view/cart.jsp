...
<div id="singleColumn">
    ...
    <c:choose>
        ...
        <c:when test="${sessionScope.cart.numberOfItems == 1}">
            <p>Your shopping cart contains ${sessionScope.cart.numberOfItems} item.</p>
        </c:when>
        <c:otherwise>
    ...
    <div id="actionBar">
        ...
        <c:set var="value">
            <c:choose>
                ...
                <c:url var="gourl" value="${value}">
            </c:url>
        <a href="${gourl}" class="bubble hMargin">continue shopping</a>
        ...
        <c:if test="${!empty sessionScope.cart && sessionScope.cart.numberOfItems != 0}">
            ...
            <h4 id="subtotal">subtotal: &euro; ${sessionScope.cart.subtotal}</h4>
        ...
        <table id="cartTable">
            ...
            <c:forEach var="cartItem" items="${sessionScope.cart.items}" varStatus="iter">
