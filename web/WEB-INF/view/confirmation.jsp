...
<div id="singleColumn">
    ...
    <p id="confirmationText">
        ...
        <strong>${requestScope.orderRecord.confirmationNumber}</strong>
        <br>
        ...
        <table id="orderSummaryTable" class="detailsTable">
            ...
            <c:forEach var="orderedProduct" items="${requestScope.orderedProducts}" varStatus="iter">
                ...
                <tr class="${((iter.index % 2) != 0) ? 'lightBlue' : 'white'}">
                    <td>${requestScope.products[iter.index].name}</td>
            ...
            <tr class="lightBlue">
                ...
                <td id="totalCellRight">&euro; ${requestScope.orderRecord.amount}</td>
            </tr>
            ...
            <tr class="lightBlue">
                <td colspan="3" id="dateProcessedRow"><strong>date processed:</strong>
                    ${requestScope.orderRecord.dateCreated}
                </td>
            </tr>
        </table>
